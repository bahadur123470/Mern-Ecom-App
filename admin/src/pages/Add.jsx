    ...
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col items-start w-full gap-3'>
            ...
            <div className='w-full'>
                ...
                <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write content about the product.' required/>
            </div>
            <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
                ...
                <div>
                    ...
                    <input onChange={(e)=>setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:max-w-[120px]' type="number" placeholder='Enter product price' />
                </div>
            </div>
