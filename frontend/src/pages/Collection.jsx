  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-top'>
        ...
        <div className='min-w-60'>
          ...
          {/* Category Filter */}
          <div className={`border border-gray-300 pl-3 py-5 mt-6 ${showFilter ? '' : "hidden"} sm:block`}>
          ...
          {/* SubCategory Filter */}
          <div className={`border border-gray-300 pl-3 py-5 my-5 ${showFilter ? '' : "hidden"} sm:block`}>
